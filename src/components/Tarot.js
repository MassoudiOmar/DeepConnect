...
import flipCardSound from '../helpers/sound'
import shuffleSound from '../helpers/SoundI'
import Swiper from 'react-native-deck-swiper';
import SVGImg from '../assets/images/Card';
...
console.log(numbers)
    ...
    async function playSoundIfEnabled(sound) {
        try {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flex: 6, bottom: '8%' }}>
                {
                    show ? <CardInstruction show={show} category={category} controlInstructionScreens={controlInstructionScreens} />
                        : <Swiper
                                    ...
                                    >
                                        <View style={{
                                            ...
                                            <FlipCard
                                                ...
                                                flip={!false}
                                                onFlipStart={() => {
                                                    playSoundIfEnabled(flipCardSound);
                                                    setTimeout(() => {
                                                        setisFlipped(true);
                                                    }, 400);
                                                }}
